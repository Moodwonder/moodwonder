...
export default class ParticipationGraph extends React.Component {
    ...
    render () {
        ...
        return (
            <div id="surveyParticipation" data-dimension="250" data-text={datapercent} data-info="" data-width="45" data-fontsize="25" data-percent={datapercent} data-fgcolor="#ef5350" data-bgcolor="#eee" data-type="half" data-icon="fa-task"></div>
        );
    }
}
